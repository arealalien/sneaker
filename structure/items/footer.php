<footer id="footer" class="flexbox">
    <div class="footer-inner view-width">
        <!-- Left -->
        <div class="footer-left">
            <a cursor-class="pointer" class="footer-icon-wrapper">
        ...
        <div class="footer-right">
            <div class="footer-sections">
                <div class="footer-section flexbox-col-left">
                    <h3 class="footer-section-heading bebas">Useful links</h3>
                    <div class="footer-section-items-wrapper">
                        ...
                        <ul class="footer-section-items">
                            ...
                            <li class="footer-section-item flexbox"><a cursor-class="pointer" class="footer-section-item-inner">Privacy Policy</a></li>
                            <li class="footer-section-item flexbox"><a cursor-class="pointer" class="footer-section-item-inner">Cookie Policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="footer-section flexbox-col-left">
                    <h3 class="footer-section-heading bebas">Subscribe</h3>
                </div>
            </div>
        </div>
    </div>
